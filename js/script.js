...
async function loadChapter(){
  ...
  let a = pdf.append('a').attr('id','prev').attr('class','btn btn-sm btn-secondary text-light ml-2 mb-2').attr('onmouseup','previousPage(\'' + pdf_path + '\')');
  a.append('span').attr('data-feather','chevron-left')
  a = pdf.append('a').attr('id','next').attr('class','btn btn-sm btn-secondary text-light ml-2 mb-2').attr('onmouseup','nextPage(\'' + pdf_path + '\')');
...
function nextPage(pdf_path){
  ...
  d3.select('#prev').attr('onmouseup','previousPage(\'' + next_path + '\')');
  d3.select('#next').attr('onmouseup','nextPage(\'' + next_path + '\')');
...
function previousPage(pdf_path){
  ...
  d3.select('#prev').attr('onmouseup','previousPage(\'' + prev_path + '\')');
  d3.select('#next').attr('onmouseup','nextPage(\'' + prev_path + '\')');
  document.getElementById('pdf-frame').contentDocument.location.reload(true);
